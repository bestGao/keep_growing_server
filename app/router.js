...
module.exports = app => {
  ...
  // 保存文章
  router.post('/keep_growing/web/save_article', controller.webArticle.saveArticle)
  // 获取文章详情
  router.get('/keep_growing/web/queryArticle',controller.webArticle.queryArticle)
